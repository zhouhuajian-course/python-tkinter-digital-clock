...
# 特殊变量和单选框进行关联
var = StringVar()
Radiobutton(frame, text="24h", value="24h", font="宋体 12", bg=bg_color, padx=5, variable=var, activebackground=bg_color).pack(side=LEFT)
Radiobutton(frame, text="12h", value="12h", font="宋体 12", bg=bg_color, padx=5, variable=var, activebackground=bg_color).pack(side=RIGHT)
var.set("24h")
